...
# window_size=7
# for step in 000200 000250 000300 000350 000400 000400
# do
#     CUDA_VISIBLE_DEVICES="0" python3 inference_with_trained_model.py \
#             --config_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/model_training/test_naiive_stepwise_window_progression_params_match_data/elantentlpips_no_ode_init_pacing-step_wise_blend-none.yaml \ 
#             --output_folder videos/test_naiive_stepwise_window_progression_params_match_data_$step \
#             --checkpoint_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/model_training/test_naiive_stepwise_window_progression_params_match_data/logs/checkpoint_model_$step/model.pt \
#             --data_path prompts/five_MovieGenVideoBench_extended.txt \
#             --use_ema \
...
# do
#     CUDA_VISIBLE_DEVICES="0" python3 inference_with_trained_model.py \
#             --config_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/model_training/test_naiive_stepwise_window_progression_params_match_data_with_no_init_with_dmd_reg_loss/elantentlpips_no_ode_init_pacing-step_wise_blend-none_with_dmd_reg_loss.yaml \
#         --output_folder videos/test_naiive_stepwise_window_progression_params_match_data_with_no_init_with_dmd_reg_loss_$step \
#             --checkpoint_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/model_training/test_naiive_stepwise_window_progression_params_match_data_with_no_init_with_dmd_reg_loss/logs/checkpoint_model_$step/model.pt \
#             --data_path prompts/five_MovieGenVideoBench_extended.txt \
#             --use_ema \
#             --first_window_size $window_size
#     ((window_size--))
...
do
    CUDA_VISIBLE_DEVICES="0" python3 inference_with_trained_model.py \
            --config_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/model_training/test_naiive_stepwise_window_progression_params_match_data/elantentlpips_no_ode_init_pacing-step_wise_blend-none.yaml \
            --output_folder videos/motion_prompts/test_naiive_stepwise_window_progression_params_match_data_$step \
            --checkpoint_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/model_training/test_naiive_stepwise_window_progression_params_match_data/logs/checkpoint_model_$step/model.pt \
