...
instance_folder_name="test_naiive_stepwise_window_progression_params_match_data_with_init_with_dmd_reg_loss"
config_name="150126_evaluate_baselines_params_match_data/elantentlpips_ode_init_pacing-step_wise_blend-none_with_dmd_reg_loss.yaml"
