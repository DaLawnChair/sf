"""
NOTE:
HERE WE ASSUME THAT WE ARE WORKING WITH VIDEO LATENTS OF THE SIZE (1,21,16,16,104), change `EXPECTED_VIDEO_SHAPE` as needed and make updates. 
The tag here is still going to be 'video' for the video_latent.


This assumes that the dataset is of the video form, so we will encode it as a video latent and save.

This is a clone of the create_lmdb_14b_shards.py file, but for videos.

python create_lmdb_shards_video_latents.py \
...
python create_lmdb_shards_video_latents.py \
--data_path /home/ma-user/work/dataset/self_forcing/self_forcing//home/ma-user/work/dataset/self_forcing/self_forcing/bidirectional_diffusion_inference_videos_guidance5.0_wan1.3B_vidprom \ --lmdb_path /home/ma-user/work/dataset/self_forcing/self_forcing/bidirectional_diffusion_inference_videos_guidance5.0_wan1.3B_vidprom_video_lmdb_11k/
"""
...
EXPECTED_VIDEO_SHAPE = (1, 21, 16, 60, 104)
