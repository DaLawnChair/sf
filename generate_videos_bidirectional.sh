...
torchrun --nnodes=$NNODES --nproc_per_node=$nproc_per_node --rdzv_id=5235 \
  ...
  scripts/generate_videos_bidirectional.py \
  --caption_path "/home/ma-user/work/algorithm/arvd_repos/091225_add_grad_acc_temp/prompts/vidprom_filtered_extended.txt" \
  --output_folder "/home/ma-user/work/dataset/self_forcing/self_forcing/again_videos_guidance3.0_wan1.3B_vidprom/" \
  --timeshift_scale 5.0 \
  --guidance_scale 6.0 # noted inside of config/self_forcing_ode.yaml
