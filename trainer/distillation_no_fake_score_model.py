...
from model import CausVid, DMD, SiD, BidirectionalMatchDMD, BidirectionalMatchDMDTeacherForcing, DMDNoFakeScoreModel
import torch
import wandb
import time
import os
...
class Trainer:
    def __init__(self, config):
        ...
        elif config.distribution_loss == "dmd_no_fake_score_model":
            self.model = DMDNoFakeScoreModel(config, device=self.device)
        else:
            raise ValueError("Invalid distribution matching loss")
            
        assert self.model.fake_score is None, "Trainer init contains fake score model!" 
