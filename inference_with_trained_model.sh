...
CUDA_VISIBLE_DEVICES="1" python3 inference_with_trained_model.py \
	...
	--output_folder videos/elatentlpips_run_basically_bidirecitonal_step_600 \
        --checkpoint_path /home/ma-user/work/dataset/john_env/self_forcing_clone/self_forcing/elantentlpips_no_ode_init_pacing-step_wise_blend-none_webstudio_test/logs/checkpoint_model_000600/model.pt \
        --data_path prompts/twentyfive_MovieGenVideoBench_extended.txt \
        --use_ema &
